...
class SauceNAO:
    ...
    def __init__(self, api_key, output_type=2, testmode=0, dbmask=None,
                 dbmaski=None, db=999, numres=1, shortlimit=20, longlimit=300):
        params = dict()
    ...
    def get_sauce(self, url):
        ...
        response = requests.get(
            'https://saucenao.com/search.php', params=self.params)
    ...
    def verify_http_status(self, response, threads):
        if response.status_code != 200:
            ...
            print('Header Status' + str(result.status_code))
            return False
        else:
            return True
